...
void Voxel::displayV() { // Point center, double length
  ...
  traceQuad(a,c,g,e,255,255,0);
  traceQuad(d,c,g,h,0,255,255);
  traceQuad(b,d,h,f,0,255,0);
  traceQuad(a,b,f,e,255,0,0);
  traceQuad(e,f,h,g,0,0,255);
...
int Voxel::isInsideSphere(CPoint* cts, double ray) { // return 0 if vox inside Sphere,
                                                    //  return 1 if outside
...
int Voxel::isInsideCylinder(CPoint* cts, CVector v,double ray) { // return 0 if vox inside Sphere,
                                                    //  return 1 if outside
                                                    // return 2 if intersection
    int retour = 0;
    int cpt = 0;
